...
struct Bhdr
{
	...
	union {
		uchar data[1];
		struct {
            /* Sorted (increasing) list of blocks of different sizes */
            Bhdr*   bhn; /* Free linked list next */
            Bhdr*   bhp; /* Free linked list parent*/
            /* Blocks of the same size */
			Bhdr*	bhv; /* Free list previous*/
			Bhdr*	bhf; /* Free list forward */
		} s;
